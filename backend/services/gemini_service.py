...
def analyze_item_image(image_paths: List[str], user = None, user_condition: str = None, user_details: str = None) -> dict:
    ...
    try:
        ...
        final_prompt = (
            ...
            "WICHTIG für 'Marke' und 'Größe': Gib diese NUR an, wenn du sie EINDEUTIG auf den Fotos erkennen "
            "kannst (z.B. ein lesbares Marken-Logo/Schriftzug oder ein sichtbares Größen-Etikett). RATE NIEMALS "
            "die Marke aus der Produktart und ERFINDE keine Größe. Im Zweifel lasse das Feld komplett WEG. "
